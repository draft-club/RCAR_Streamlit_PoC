...
def main():
    """Main workflow for standardizing column names using cosine similarity."""
    # Hardcoded input columns (replace this with your actual column inputs)
    input_columns = ["رقم القطع الاراضية في تصمم", "مساحة بالمتر المربع شامل", "أسماء الملاك", "مبلغ التعويض المستحق", "عدد السكان", "الطقس اليوم"]

    # Standardize the columns and get the best matching reference columns along with scores
    renamed_columns = standardize_columns(input_columns)
